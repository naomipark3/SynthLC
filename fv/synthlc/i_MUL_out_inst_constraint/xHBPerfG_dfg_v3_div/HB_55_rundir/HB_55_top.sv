...
`ifndef WHB
HB_55: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_55: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_55: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_55: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
