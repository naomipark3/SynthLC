...
`ifndef WHB
HB_30: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_30: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_30: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_30: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
