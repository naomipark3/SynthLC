...
`ifndef WHB
HB_56: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_56: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_56: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_56: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
