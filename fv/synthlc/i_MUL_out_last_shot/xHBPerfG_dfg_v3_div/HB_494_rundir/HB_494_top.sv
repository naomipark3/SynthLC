...
`ifndef WHB
HB_494: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_494: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_494: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_494: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
