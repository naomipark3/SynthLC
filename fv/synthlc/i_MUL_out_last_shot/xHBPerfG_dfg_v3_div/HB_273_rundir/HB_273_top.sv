...
`ifndef WHB
HB_273: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_273: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_273: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_273: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
