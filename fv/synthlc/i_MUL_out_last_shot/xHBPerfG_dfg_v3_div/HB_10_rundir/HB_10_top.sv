...
`ifndef WHB
HB_10: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_10: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_10: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_10: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
