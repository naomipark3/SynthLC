...
`ifndef WHB
HB_272: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_272: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_272: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_272: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
