...
`ifndef WHB
HB_250: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_250: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_250: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_250: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
