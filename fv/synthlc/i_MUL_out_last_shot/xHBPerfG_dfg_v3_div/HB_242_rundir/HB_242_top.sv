...
`ifndef WHB
HB_242: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_242: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_242: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_242: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
