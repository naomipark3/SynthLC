...
`ifndef WHB
HB_209: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_209: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_209: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_209: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
