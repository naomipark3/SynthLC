...
`ifndef WHB
HB_230: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_230: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_230: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_230: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
