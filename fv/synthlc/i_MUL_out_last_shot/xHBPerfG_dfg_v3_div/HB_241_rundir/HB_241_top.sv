...
`ifndef WHB
HB_241: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_241: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_241: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_241: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
