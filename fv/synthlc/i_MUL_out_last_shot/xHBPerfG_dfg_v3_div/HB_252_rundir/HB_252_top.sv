...
`ifndef WHB
HB_252: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_252: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_252: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_252: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
