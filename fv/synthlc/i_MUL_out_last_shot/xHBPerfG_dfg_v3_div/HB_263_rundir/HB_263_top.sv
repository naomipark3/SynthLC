...
`ifndef WHB
HB_263: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_263: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_263: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_263: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
