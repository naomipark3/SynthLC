...
`ifndef WHB
HB_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_8: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
