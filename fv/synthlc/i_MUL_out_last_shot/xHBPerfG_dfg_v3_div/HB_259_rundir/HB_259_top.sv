...
`ifndef WHB
HB_259: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_259: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_259: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_259: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
