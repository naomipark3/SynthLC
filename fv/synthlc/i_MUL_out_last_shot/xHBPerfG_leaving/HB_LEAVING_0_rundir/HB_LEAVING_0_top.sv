...
`ifndef WHB
HB_LEAVING_div_fsm_s9_wb_stage_s1: assert property (@(posedge clk_i) 
    ($past(div_fsm_s9, 2) && 
        $past(div_fsm_s9) && (!div_fsm_s9)) |-> 
    $past(!(wb_stage_s1_hpn || wb_stage_s1)));
`else 
WHB_LEAVING_div_fsm_s9_hb_wb_stage_s1: assert property (@(posedge clk_i) 
    ($past(div_fsm_s9, 2) && 
        $past(div_fsm_s9) && (!div_fsm_s9)) |-> $past(!(wb_stage_s1_hpn)));
WHB_CONCUR_LEAVING_div_fsm_s9_hb_wb_stage_s1: assert property (@(posedge clk_i) 
    ($past(div_fsm_s9, 2) && 
        $past(div_fsm_s9) && (!div_fsm_s9)) |-> $past(!(wb_stage_s1_hpn) && wb_stage_s1));
`endif 
