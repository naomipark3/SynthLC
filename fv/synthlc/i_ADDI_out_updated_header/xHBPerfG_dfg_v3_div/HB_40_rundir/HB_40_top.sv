...
`ifndef WHB
HB_40: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_40: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_40: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_40: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
