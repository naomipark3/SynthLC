...
`ifndef WHB
HB_2: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_2: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_2: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_2: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
