...
`ifndef WHB
HB_318: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_318: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_318: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_318: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
