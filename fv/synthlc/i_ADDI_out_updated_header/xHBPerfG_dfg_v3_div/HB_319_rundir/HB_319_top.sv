...
`ifndef WHB
HB_319: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_319: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_319: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_319: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
