...
`ifndef WHB
HB_304: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_304: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_304: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_304: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
