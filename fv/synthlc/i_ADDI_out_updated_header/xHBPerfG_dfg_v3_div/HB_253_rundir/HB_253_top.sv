...
`ifndef WHB
HB_253: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_253: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_253: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_253: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
