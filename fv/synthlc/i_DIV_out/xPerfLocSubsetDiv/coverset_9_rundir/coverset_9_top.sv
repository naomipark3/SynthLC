...
C_9_N: cover property (@(posedge clk_i) id_stage_s1_hpn & div_fsm_s2_hpn & div_fsm_s3_hpn & wb_stage_s1_hpn & 1'b1 & !(id_stage_s1 | div_fsm_s2 | div_fsm_s3 | wb_stage_s1 | 1'b0));
endmodule
