...
C_22_N: cover property (@(posedge clk_i) id_stage_s1_hpn & div_fsm_s14_hpn & div_fsm_s6_hpn & wb_stage_s1_hpn & 1'b1 & !(id_stage_s1 | div_fsm_s14 | div_fsm_s6 | wb_stage_s1 | 1'b0));
endmodule
