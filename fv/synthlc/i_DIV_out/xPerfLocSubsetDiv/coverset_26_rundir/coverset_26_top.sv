...
C_26_N: cover property (@(posedge clk_i) id_stage_s1_hpn & mult_fsm_s2_hpn & mult_fsm_s5_hpn & wb_stage_s1_hpn & 1'b1 & !(id_stage_s1 | mult_fsm_s2 | mult_fsm_s5 | wb_stage_s1 | 1'b0));
endmodule
