...
`ifndef WHB
HB_321: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_321: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_321: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_321: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
