...
`ifndef WHB
HB_369: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_369: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_369: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_369: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
