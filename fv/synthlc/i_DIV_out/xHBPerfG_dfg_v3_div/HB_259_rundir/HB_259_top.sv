...
`ifndef WHB
HB_259: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_259: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_259: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_259: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
