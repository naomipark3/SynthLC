...
`ifndef WHB
HB_93: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_93: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_93: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_93: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
