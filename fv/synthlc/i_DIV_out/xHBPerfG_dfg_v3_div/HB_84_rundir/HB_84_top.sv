...
`ifndef WHB
HB_84: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_84: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_84: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_84: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
