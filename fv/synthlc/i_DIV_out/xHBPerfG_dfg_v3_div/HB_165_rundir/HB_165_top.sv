...
`ifndef WHB
HB_165: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_165: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_165: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_165: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
