...
`ifndef WHB
HB_77: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_77: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_77: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_77: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
