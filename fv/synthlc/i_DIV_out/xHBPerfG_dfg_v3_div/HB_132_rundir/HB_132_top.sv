...
`ifndef WHB
HB_132: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_132: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_132: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_132: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
