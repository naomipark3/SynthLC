...
`ifndef WHB
HB_75: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_75: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_75: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_75: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
