...
`ifndef WHB
HB_372: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_372: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_372: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_372: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
