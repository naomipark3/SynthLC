...
`ifndef WHB
HB_9: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_9: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_9: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_9: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
