...
`ifndef WHB
HB_115: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(mult_fsm_s7_hpn || mult_fsm_s7));
`else 
//C_115: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (mult_fsm_s7 && !mult_fsm_s7_hpn));
WHB_115: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !mult_fsm_s7_hpn);
WHB_CONCUR_115: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (mult_fsm_s7 && !mult_fsm_s7_hpn));
`endif 
