...
`ifndef WHB
HB_80: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_80: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_80: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_80: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
