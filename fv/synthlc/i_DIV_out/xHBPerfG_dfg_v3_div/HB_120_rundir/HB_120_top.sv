...
`ifndef WHB
HB_120: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_120: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_120: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_120: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
