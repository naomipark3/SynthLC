...
`ifndef WHB
HB_410: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_410: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_410: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_410: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
