...
`ifndef WHB
HB_113: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_113: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_113: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_113: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
