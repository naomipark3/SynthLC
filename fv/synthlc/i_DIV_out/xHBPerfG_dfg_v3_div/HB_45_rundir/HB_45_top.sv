...
`ifndef WHB
HB_45: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_45: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_45: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_45: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
