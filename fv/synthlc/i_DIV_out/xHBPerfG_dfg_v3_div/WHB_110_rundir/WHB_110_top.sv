...
`ifndef WHB
HB_110: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_110: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_110: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_110: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
