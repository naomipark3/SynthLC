...
`ifndef WHB
HB_79: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_79: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_79: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_79: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
