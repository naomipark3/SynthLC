...
`ifndef WHB
HB_413: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_413: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_413: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_413: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
