...
`ifndef WHB
HB_46: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_46: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_46: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_46: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
