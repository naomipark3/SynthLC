...
`ifndef WHB
HB_4: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_4: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_4: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_4: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
