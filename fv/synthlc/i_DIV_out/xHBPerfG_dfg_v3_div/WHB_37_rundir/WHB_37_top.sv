...
`ifndef WHB
HB_37: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_37: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_37: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_37: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
