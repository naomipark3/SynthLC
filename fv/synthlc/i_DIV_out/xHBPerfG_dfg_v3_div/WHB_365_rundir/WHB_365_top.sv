...
`ifndef WHB
HB_365: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_365: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_365: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_365: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
