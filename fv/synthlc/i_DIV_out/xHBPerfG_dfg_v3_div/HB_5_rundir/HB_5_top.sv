...
`ifndef WHB
HB_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(mult_fsm_s7_hpn || mult_fsm_s7));
`else 
//C_5: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (mult_fsm_s7 && !mult_fsm_s7_hpn));
WHB_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !mult_fsm_s7_hpn);
WHB_CONCUR_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (mult_fsm_s7 && !mult_fsm_s7_hpn));
`endif 
