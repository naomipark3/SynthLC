...
`ifndef WHB
HB_90: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_90: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_90: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_90: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
