...
`ifndef WHB
HB_136: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_136: cover property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_136: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_136: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
