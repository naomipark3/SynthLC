...
`ifndef WHB
HB_284: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_284: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_284: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_284: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
