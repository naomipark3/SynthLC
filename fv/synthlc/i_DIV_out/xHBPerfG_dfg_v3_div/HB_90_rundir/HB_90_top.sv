...
`ifndef WHB
HB_90: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_90: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_90: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_90: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
