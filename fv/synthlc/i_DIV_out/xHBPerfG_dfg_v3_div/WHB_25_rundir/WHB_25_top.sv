...
`ifndef WHB
HB_25: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_25: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_25: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_25: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
