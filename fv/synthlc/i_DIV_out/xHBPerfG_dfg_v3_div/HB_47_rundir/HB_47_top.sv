...
`ifndef WHB
HB_47: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_47: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_47: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_47: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
