...
`ifndef WHB
HB_213: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_213: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_213: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_213: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
