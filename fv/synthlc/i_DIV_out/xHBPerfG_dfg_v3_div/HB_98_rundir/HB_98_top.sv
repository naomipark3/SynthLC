...
`ifndef WHB
HB_98: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_98: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_98: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_98: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
