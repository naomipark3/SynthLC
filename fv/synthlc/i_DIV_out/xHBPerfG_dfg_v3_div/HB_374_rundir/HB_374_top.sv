...
`ifndef WHB
HB_374: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_374: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_374: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_374: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
