...
`ifndef WHB
HB_181: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_181: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_181: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_181: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
