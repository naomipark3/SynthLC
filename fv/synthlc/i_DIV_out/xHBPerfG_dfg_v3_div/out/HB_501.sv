...
`ifndef WHB
HB_501: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_501: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_501: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_501: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
