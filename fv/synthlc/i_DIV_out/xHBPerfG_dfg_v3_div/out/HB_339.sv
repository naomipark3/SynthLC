...
`ifndef WHB
HB_339: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_339: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_339: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_339: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
