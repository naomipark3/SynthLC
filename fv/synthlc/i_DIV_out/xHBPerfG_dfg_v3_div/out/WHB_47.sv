...
`ifndef WHB
HB_47: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_47: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_47: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_47: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
