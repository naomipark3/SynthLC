...
`ifndef WHB
HB_48: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_48: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_48: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_48: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
