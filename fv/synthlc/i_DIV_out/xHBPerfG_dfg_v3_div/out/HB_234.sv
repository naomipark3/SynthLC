...
`ifndef WHB
HB_234: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_234: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_234: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_234: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
