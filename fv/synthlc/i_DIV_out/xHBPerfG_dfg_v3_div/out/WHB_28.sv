...
`ifndef WHB
HB_28: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_28: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_28: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_28: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
