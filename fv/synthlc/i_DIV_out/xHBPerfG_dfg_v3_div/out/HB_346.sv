...
`ifndef WHB
HB_346: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_346: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_346: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_346: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
