...
`ifndef WHB
HB_33: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_33: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_33: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_33: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
