...
`ifndef WHB
HB_132: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_132: cover property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_132: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_132: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
