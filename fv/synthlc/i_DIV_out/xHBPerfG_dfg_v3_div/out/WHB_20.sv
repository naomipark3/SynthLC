...
`ifndef WHB
HB_20: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_20: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_20: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_20: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
