...
`ifndef WHB
HB_391: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_391: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_391: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_391: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
