...
`ifndef WHB
HB_373: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_373: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_373: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_373: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
