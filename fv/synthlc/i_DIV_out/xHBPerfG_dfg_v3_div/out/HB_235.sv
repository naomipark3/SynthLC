...
`ifndef WHB
HB_235: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_235: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_235: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_235: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
