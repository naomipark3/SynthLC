...
`ifndef WHB
HB_340: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_340: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_340: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_340: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
