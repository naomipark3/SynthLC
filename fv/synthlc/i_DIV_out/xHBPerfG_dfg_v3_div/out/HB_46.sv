...
`ifndef WHB
HB_46: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_46: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_46: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_46: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
