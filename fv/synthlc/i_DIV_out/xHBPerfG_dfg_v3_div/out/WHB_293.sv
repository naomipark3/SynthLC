...
`ifndef WHB
HB_293: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_293: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_293: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_293: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
