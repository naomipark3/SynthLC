...
`ifndef WHB
HB_192: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_192: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_192: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_192: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
