...
`ifndef WHB
HB_43: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_43: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_43: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_43: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
