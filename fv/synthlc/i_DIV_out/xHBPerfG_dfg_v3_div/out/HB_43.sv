...
`ifndef WHB
HB_43: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_43: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_43: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_43: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
