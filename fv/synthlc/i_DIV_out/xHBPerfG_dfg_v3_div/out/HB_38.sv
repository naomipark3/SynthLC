...
`ifndef WHB
HB_38: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_38: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_38: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_38: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
