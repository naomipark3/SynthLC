...
`ifndef WHB
HB_137: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_137: cover property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_137: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_137: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
