...
`ifndef WHB
HB_168: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_168: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_168: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_168: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
