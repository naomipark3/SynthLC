...
`ifndef WHB
HB_315: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_315: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_315: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_315: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
