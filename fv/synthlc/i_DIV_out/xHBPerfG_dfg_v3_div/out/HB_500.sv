...
`ifndef WHB
HB_500: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_500: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_500: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_500: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
