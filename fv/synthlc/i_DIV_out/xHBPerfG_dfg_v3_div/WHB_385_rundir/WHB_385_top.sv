...
`ifndef WHB
HB_385: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_385: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_385: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_385: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
