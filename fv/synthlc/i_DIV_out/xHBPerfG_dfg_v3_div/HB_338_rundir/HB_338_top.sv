...
`ifndef WHB
HB_338: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_338: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_338: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_338: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
