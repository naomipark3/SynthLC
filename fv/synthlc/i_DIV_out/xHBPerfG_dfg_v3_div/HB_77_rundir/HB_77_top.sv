...
`ifndef WHB
HB_77: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_77: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_77: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_77: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
