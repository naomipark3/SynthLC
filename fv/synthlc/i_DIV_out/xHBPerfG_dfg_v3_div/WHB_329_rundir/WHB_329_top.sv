...
`ifndef WHB
HB_329: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_329: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_329: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_329: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
