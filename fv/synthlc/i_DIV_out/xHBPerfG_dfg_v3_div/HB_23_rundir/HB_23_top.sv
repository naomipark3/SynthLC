...
`ifndef WHB
HB_23: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_23: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_23: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_23: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
