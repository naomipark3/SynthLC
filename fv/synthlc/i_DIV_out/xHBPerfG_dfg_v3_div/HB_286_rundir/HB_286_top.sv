...
`ifndef WHB
HB_286: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_286: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_286: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_286: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
