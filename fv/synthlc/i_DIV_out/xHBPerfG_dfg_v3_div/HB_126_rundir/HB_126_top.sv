...
`ifndef WHB
HB_126: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_126: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_126: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_126: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
