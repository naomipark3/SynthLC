...
`ifndef WHB
HB_44: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_44: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_44: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_44: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
