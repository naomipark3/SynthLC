...
`ifndef WHB
HB_106: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_106: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_106: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_106: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
