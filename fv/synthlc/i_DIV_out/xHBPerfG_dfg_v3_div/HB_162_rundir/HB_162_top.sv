...
`ifndef WHB
HB_162: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_162: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_162: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_162: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
