...
`ifndef WHB
HB_190: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_190: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_190: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_190: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
