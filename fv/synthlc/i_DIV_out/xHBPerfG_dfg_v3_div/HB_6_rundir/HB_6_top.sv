...
`ifndef WHB
HB_6: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_6: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_6: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_6: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
