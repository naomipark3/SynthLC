...
`ifndef WHB
HB_389: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_389: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_389: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_389: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
