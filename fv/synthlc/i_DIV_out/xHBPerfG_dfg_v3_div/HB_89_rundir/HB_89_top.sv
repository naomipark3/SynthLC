...
`ifndef WHB
HB_89: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_89: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_89: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_89: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
