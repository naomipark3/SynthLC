...
`ifndef WHB
HB_108: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_108: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_108: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_108: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
