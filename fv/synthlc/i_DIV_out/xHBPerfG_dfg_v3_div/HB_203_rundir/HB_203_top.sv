...
`ifndef WHB
HB_203: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_203: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_203: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_203: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
