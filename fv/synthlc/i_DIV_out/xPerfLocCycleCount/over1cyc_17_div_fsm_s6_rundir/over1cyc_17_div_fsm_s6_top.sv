...
A_PATH: assume property (@(posedge clk_i) first |-> s_eventually (id_stage_s1_hpn && div_fsm_s1_hpn && div_fsm_s2_hpn && div_fsm_s3_hpn && div_fsm_s4_hpn && div_fsm_s5_hpn && div_fsm_s6_hpn && div_fsm_s9_hpn && 1 ));

CS_gt_div_fsm_s6_2: cover property (@(posedge clk_i) 
    div_fsm_s6 [*2] ##1 !div_fsm_s6 ##[0:$] id_stage_s1_hpn && div_fsm_s1_hpn && div_fsm_s2_hpn && div_fsm_s3_hpn && div_fsm_s4_hpn && div_fsm_s5_hpn && div_fsm_s6_hpn && div_fsm_s9_hpn && 1 );
