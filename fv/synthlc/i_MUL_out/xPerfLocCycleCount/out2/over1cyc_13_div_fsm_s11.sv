...
CS_gt_div_fsm_s11_2: cover property (@(posedge clk_i) 
    div_fsm_s11 [*2] ##1 !div_fsm_s11 ##[0:$] id_stage_s1_hpn && div_fsm_s10_hpn && div_fsm_s11_hpn && div_fsm_s12_hpn && div_fsm_s13_hpn && div_fsm_s9_hpn && lsu_fsm_s8_hpn && wb_stage_s1_hpn && 1 );
