...
`ifndef WHB
HB_27: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_27: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_27: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_27: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
