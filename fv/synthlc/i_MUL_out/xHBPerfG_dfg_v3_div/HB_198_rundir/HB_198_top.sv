...
`ifndef WHB
HB_198: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_198: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_198: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_198: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
