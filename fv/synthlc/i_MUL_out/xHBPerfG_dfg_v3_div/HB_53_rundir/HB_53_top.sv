...
`ifndef WHB
HB_53: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_53: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_53: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_53: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
