...
`ifndef WHB
HB_56: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_56: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_56: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_56: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
