...
`ifndef WHB
HB_16: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_16: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_16: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_16: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
