...
`ifndef WHB
HB_45: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_45: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_45: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_45: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
