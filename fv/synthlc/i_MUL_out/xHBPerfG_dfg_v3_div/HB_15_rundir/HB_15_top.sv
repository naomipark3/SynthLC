...
`ifndef WHB
HB_15: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_15: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_15: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_15: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
