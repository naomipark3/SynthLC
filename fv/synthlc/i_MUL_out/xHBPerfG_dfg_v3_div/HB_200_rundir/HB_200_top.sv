...
`ifndef WHB
HB_200: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_200: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_200: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_200: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
