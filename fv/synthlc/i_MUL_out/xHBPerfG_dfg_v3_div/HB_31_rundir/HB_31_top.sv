...
`ifndef WHB
HB_31: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_31: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_31: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_31: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
