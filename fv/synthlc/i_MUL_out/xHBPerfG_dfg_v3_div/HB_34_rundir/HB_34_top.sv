...
`ifndef WHB
HB_34: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_34: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_34: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_34: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
