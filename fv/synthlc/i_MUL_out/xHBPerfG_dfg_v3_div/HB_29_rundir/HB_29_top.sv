...
`ifndef WHB
HB_29: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_29: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_29: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_29: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
