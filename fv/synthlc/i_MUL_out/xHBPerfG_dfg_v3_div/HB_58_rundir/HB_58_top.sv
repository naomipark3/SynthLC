...
`ifndef WHB
HB_58: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_58: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_58: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_58: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
