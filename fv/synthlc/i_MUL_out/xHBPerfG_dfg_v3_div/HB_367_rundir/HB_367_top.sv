...
`ifndef WHB
HB_367: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_367: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_367: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_367: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
