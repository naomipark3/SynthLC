...
`ifndef WHB
HB_114: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_114: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_114: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_114: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
