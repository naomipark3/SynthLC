...
`ifndef WHB
HB_322: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_322: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_322: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_322: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
