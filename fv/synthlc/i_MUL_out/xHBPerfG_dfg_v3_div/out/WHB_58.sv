...
`ifndef WHB
HB_58: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_58: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_58: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_58: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
