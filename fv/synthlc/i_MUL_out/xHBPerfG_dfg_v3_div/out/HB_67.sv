...
`ifndef WHB
HB_67: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_67: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_67: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_67: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
