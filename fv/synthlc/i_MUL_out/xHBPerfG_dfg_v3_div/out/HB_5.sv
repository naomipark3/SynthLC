...
`ifndef WHB
HB_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_5: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
