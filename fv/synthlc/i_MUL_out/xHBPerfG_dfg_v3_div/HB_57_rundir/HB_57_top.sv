...
`ifndef WHB
HB_57: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_57: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_57: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_57: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
