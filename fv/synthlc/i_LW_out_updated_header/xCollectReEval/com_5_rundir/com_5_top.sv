...
CS_lsu_fsm_s8_hb_div_fsm_s14: cover property (@(posedge clk_i) (lsu_fsm_s8 & !lsu_fsm_s8_hpn & !(div_fsm_s14_hpn | div_fsm_s14)) ##[0:$] set_r);

CS_lsu_fsm_s8_concur_div_fsm_s14: cover property (@(posedge clk_i) (lsu_fsm_s8 & !lsu_fsm_s8_hpn & div_fsm_s14 & !div_fsm_s14_hpn) ##[0:$] set_r);

CS_wb_stage_s1_hb_div_fsm_s14: cover property (@(posedge clk_i) (wb_stage_s1 & !wb_stage_s1_hpn & !(div_fsm_s14_hpn | div_fsm_s14)) ##[0:$] set_r);

CS_wb_stage_s1_concur_div_fsm_s14: cover property (@(posedge clk_i) (wb_stage_s1 & !wb_stage_s1_hpn & div_fsm_s14 & !div_fsm_s14_hpn) ##[0:$] set_r);
