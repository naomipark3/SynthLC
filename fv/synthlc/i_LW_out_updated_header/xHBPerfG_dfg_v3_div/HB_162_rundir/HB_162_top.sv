...
`ifndef WHB
HB_162: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_162: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_162: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_162: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
