...
`ifndef WHB
HB_264: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_264: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_264: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_264: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
