...
`ifndef WHB
HB_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_8: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
