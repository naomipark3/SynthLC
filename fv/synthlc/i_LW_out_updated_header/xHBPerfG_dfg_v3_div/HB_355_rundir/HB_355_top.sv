...
`ifndef WHB
HB_355: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_355: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_355: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_355: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
