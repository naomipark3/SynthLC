...
`ifndef WHB
HB_131: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_131: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_131: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_131: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
