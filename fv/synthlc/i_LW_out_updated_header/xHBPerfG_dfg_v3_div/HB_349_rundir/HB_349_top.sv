...
`ifndef WHB
HB_349: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_349: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_349: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_349: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
