...
`ifndef WHB
HB_358: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_358: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_358: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_358: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
