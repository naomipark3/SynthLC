...
`ifndef WHB
HB_348: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_348: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_348: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_348: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
