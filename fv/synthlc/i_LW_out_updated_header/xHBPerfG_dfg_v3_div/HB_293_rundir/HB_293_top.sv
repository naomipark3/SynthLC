...
`ifndef WHB
HB_293: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_293: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_293: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_293: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
