...
`ifndef WHB
HB_169: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_169: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_169: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_169: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
