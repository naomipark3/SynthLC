...
`ifndef WHB
HB_204: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_204: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_204: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_204: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
