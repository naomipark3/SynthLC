...
`ifndef WHB
HB_152: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_152: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_152: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_152: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
