...
`ifndef WHB
HB_171: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_171: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_171: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_171: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
