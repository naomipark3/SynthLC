...
`ifndef WHB
HB_151: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_151: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_151: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_151: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
