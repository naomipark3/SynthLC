...
`ifndef WHB
HB_280: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_280: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_280: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_280: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
