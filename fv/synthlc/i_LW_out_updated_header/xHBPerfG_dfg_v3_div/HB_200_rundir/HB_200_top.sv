...
`ifndef WHB
HB_200: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_200: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_200: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_200: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
