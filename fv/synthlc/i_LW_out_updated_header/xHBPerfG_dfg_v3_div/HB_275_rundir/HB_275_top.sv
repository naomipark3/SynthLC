...
`ifndef WHB
HB_275: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_275: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_275: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_275: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
