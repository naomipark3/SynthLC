...
`ifndef WHB
HB_98: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_98: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_98: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_98: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
