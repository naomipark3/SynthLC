...
`ifndef WHB
HB_340: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_340: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_340: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_340: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
