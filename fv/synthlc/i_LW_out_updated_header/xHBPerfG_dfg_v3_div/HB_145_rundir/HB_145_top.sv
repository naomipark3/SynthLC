...
`ifndef WHB
HB_145: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_145: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_145: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_145: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
