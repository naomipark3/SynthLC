...
`ifndef WHB
HB_36: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_36: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_36: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_36: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
