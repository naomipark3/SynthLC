...
`ifndef WHB
HB_330: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_330: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_330: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_330: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
