...
`ifndef WHB
HB_93: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_93: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_93: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_93: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
