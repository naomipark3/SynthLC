...
`ifndef WHB
HB_234: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_234: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_234: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_234: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
