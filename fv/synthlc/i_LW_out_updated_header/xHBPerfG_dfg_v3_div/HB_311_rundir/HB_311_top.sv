...
`ifndef WHB
HB_311: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_311: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_311: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_311: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
