...
`ifndef WHB
HB_351: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_351: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_351: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_351: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
