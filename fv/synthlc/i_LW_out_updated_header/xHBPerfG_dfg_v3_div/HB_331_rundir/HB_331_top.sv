...
`ifndef WHB
HB_331: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_331: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_331: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_331: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
