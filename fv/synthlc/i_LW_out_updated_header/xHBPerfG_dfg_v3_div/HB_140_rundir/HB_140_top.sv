...
`ifndef WHB
HB_140: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_140: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_140: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_140: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
