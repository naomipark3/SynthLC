...
`ifndef WHB
HB_185: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_185: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_185: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_185: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
