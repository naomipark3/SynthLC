...
`ifndef WHB
HB_79: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_79: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_79: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_79: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
