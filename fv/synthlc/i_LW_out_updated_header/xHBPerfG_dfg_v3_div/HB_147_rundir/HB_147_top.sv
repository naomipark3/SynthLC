...
`ifndef WHB
HB_147: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_147: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_147: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_147: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
