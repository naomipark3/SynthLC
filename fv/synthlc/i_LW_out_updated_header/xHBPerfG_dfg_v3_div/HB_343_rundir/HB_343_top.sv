...
`ifndef WHB
HB_343: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_343: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_343: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_343: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
