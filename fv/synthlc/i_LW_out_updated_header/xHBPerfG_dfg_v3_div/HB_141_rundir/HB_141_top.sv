...
`ifndef WHB
HB_141: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_141: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_141: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_141: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
