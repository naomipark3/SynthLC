...
`ifndef WHB
HB_133: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_133: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_133: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_133: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
