...
`ifndef WHB
HB_226: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_226: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_226: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_226: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
