...
`ifndef WHB
HB_278: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_278: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_278: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_278: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
