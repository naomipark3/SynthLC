...
`ifndef WHB
HB_255: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_255: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_255: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_255: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
