...
`ifndef WHB
HB_184: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_184: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_184: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_184: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
