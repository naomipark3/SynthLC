...
`ifndef WHB
HB_273: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_273: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_273: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_273: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
