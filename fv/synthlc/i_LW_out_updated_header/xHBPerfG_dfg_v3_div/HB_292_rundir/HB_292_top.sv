...
`ifndef WHB
HB_292: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_292: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_292: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_292: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
