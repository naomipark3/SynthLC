...
`ifndef WHB
HB_20: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_20: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_20: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_20: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
