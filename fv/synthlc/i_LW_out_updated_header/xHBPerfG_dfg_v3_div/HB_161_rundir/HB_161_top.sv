...
`ifndef WHB
HB_161: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_161: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_161: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_161: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
