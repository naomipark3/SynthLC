...
`ifndef WHB
HB_321: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_321: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_321: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_321: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
