...
`ifndef WHB
HB_241: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_241: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_241: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_241: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
