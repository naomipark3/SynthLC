...
`ifndef WHB
HB_346: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_346: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_346: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_346: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
