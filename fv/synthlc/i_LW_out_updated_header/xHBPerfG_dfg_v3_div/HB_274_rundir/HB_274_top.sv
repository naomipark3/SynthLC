...
`ifndef WHB
HB_274: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_274: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_274: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_274: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
