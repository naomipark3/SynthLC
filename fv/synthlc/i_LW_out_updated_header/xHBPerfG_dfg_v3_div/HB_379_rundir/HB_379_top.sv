...
`ifndef WHB
HB_379: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_379: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_379: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_379: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
