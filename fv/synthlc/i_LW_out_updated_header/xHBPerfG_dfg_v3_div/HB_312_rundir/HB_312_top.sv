...
`ifndef WHB
HB_312: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_312: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_312: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_312: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
