...
`ifndef WHB
HB_350: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_350: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_350: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_350: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
