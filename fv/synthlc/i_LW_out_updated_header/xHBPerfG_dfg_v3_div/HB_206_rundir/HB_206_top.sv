...
`ifndef WHB
HB_206: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_206: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_206: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_206: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
