...
`ifndef WHB
HB_235: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_235: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_235: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_235: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
