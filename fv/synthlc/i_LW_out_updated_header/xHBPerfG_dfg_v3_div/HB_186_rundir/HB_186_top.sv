...
`ifndef WHB
HB_186: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_186: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_186: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_186: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
