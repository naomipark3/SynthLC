...
`ifndef WHB
HB_219: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_219: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_219: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_219: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
