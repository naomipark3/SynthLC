...
`ifndef WHB
HB_334: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_334: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_334: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_334: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
