...
`ifndef WHB
HB_279: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_279: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_279: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_279: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
