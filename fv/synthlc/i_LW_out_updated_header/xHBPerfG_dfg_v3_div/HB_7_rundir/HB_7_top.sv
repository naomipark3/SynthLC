...
`ifndef WHB
HB_7: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_7: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_7: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_7: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
