...
`ifndef WHB
HB_lsu_fsm_s8_LEAVING_div_fsm_s9: assert property (@(posedge clk_i) 
    ($past(!lsu_fsm_s8_hpn) && lsu_fsm_s8 && (div_fsm_s9_hpn || div_fsm_s9)) |=>
     div_fsm_s9);
`else 
WHB_lsu_fsm_s8_LEAVING_div_fsm_s9: assert property (@(posedge clk_i) 
    ($past(!lsu_fsm_s8_hpn) && lsu_fsm_s8 && div_fsm_s9_hpn) |->
    div_fsm_s9);
WHB_CONCUR_lsu_fsm_s8_LEAVING_div_fsm_s9: assert property (@(posedge clk_i) 
    ($past(!lsu_fsm_s8_hpn) && lsu_fsm_s8 && div_fsm_s9_hpn && div_fsm_s9) |=>
    (!div_fsm_s9));
`endif 
