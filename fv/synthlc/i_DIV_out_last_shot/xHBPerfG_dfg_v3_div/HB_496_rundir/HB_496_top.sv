...
`ifndef WHB
HB_496: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_496: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_496: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_496: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
