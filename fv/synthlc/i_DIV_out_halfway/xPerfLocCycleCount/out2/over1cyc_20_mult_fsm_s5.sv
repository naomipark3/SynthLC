...
A_PATH: assume property (@(posedge clk_i) first |-> s_eventually (id_stage_s1_hpn && mult_fsm_s5_hpn && mult_fsm_s6_hpn && 1 ));

CS_gt_mult_fsm_s5_2: cover property (@(posedge clk_i) 
    mult_fsm_s5 [*2] ##1 !mult_fsm_s5 ##[0:$] id_stage_s1_hpn && mult_fsm_s5_hpn && mult_fsm_s6_hpn && 1 );
