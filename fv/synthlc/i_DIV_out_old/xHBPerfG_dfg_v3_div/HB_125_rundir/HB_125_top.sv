...
`ifndef WHB
HB_125: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_125: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_125: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_125: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
