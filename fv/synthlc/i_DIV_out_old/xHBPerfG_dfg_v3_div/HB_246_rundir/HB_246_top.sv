...
`ifndef WHB
HB_246: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_246: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_246: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_246: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
