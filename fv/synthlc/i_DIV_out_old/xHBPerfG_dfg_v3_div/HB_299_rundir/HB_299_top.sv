...
`ifndef WHB
HB_299: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_299: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_299: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_299: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
