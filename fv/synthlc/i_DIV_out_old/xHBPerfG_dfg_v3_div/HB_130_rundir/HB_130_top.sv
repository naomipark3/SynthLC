...
`ifndef WHB
HB_130: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_130: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_130: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_130: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
