...
`ifndef WHB
HB_38: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_38: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_38: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_38: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
