...
NOHALT_IF: assume property (@(posedge clk_i)
  core_i.id_stage_i.controller_i.halt_if == 1'b0
);
...
wire multdiv_ready_id_i = core_i.ex_block_i.gen_multdiv_fast.multdiv_i.multdiv_ready_id_i;

wire mult_start = mult_en && (mult_state == 2'd0) && !mul_owner_v; // ALBL
wire div_start  = div_en  && (div_state  == 3'd0) && !div_owner_v; // MD_IDLE

wire mul_done   = mul_owner_v && valid && multdiv_ready_id_i;
wire div_done   = div_owner_v && valid && multdiv_ready_id_i;
...
end// NIA header — base assumptions provided by FVMACRO in RUN_JG.sh
...
C_1: cover property (@(posedge clk_i) mult_fsm_s1);
...
C_6: cover property (@(posedge clk_i) mult_fsm_s7);
C_7: cover property (@(posedge clk_i) div_fsm_s1);
C_8: cover property (@(posedge clk_i) div_fsm_s10);
C_9: cover property (@(posedge clk_i) div_fsm_s11);
C_10: cover property (@(posedge clk_i) div_fsm_s12);
C_11: cover property (@(posedge clk_i) div_fsm_s13);
C_12: cover property (@(posedge clk_i) div_fsm_s14);
C_13: cover property (@(posedge clk_i) div_fsm_s2);
C_14: cover property (@(posedge clk_i) div_fsm_s3);
C_15: cover property (@(posedge clk_i) div_fsm_s4);
C_16: cover property (@(posedge clk_i) div_fsm_s5);
C_17: cover property (@(posedge clk_i) div_fsm_s6);
C_18: cover property (@(posedge clk_i) div_fsm_s9);
C_19: cover property (@(posedge clk_i) lsu_fsm_s10);
C_20: cover property (@(posedge clk_i) lsu_fsm_s2);
C_21: cover property (@(posedge clk_i) lsu_fsm_s8);
C_22: cover property (@(posedge clk_i) wb_stage_s1);
