...
C_5_N: cover property (@(posedge clk_i) id_stage_s1_hpn & div_fsm_s10_hpn & div_fsm_s9_hpn & wb_stage_s1_hpn & 1'b1 & !(id_stage_s1 | div_fsm_s10 | div_fsm_s9 | wb_stage_s1 | 1'b0));
endmodule
