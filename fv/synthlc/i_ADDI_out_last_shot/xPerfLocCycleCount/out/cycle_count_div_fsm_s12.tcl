...
while 1 {
  ...
  set CMD "cover -name consec_$itm\_$pivotValue  {@(posedge clk_i) $itm \[*$pivotValue\] ##1 !$itm }"
  puts $CMD
  try { 
    eval $CMD
  } on error {} {
...
#
report -csv -file /home/users/cheriek/Documents/Formal_Method/final_project/SynthLC/fv/synthlc/i_ADDI_out/xPerfLocCycleCount/max_cycle_count_div_fsm_s12.csv 
