...
`ifndef WHB
HB_407: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_407: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_407: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_407: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
