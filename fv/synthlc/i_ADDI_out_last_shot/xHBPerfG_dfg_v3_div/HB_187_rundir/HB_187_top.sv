...
`ifndef WHB
HB_187: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_187: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_187: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_187: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
