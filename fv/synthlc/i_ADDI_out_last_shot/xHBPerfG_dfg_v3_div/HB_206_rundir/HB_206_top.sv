...
`ifndef WHB
HB_206: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_206: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_206: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_206: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
