...
`ifndef WHB
HB_215: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_215: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_215: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_215: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
