...
`ifndef WHB
HB_493: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_493: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_493: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_493: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
