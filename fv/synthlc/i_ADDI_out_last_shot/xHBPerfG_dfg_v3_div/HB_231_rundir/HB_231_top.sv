...
`ifndef WHB
HB_231: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_231: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_231: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_231: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
