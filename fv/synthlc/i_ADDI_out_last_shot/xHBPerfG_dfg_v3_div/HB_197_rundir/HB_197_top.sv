...
`ifndef WHB
HB_197: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_197: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_197: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_197: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
