...
`ifndef WHB
HB_275: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_275: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_275: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_275: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
