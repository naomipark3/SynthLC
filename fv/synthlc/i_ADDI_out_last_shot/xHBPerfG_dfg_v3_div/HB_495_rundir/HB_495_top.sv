...
`ifndef WHB
HB_495: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_495: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_495: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_495: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
