...
`ifndef WHB
HB_492: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_492: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_492: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_492: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
