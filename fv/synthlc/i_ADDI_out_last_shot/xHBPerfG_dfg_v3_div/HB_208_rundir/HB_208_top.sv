...
`ifndef WHB
HB_208: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_208: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_208: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_208: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
