...
`ifndef WHB
HB_406: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_406: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_406: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_406: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
