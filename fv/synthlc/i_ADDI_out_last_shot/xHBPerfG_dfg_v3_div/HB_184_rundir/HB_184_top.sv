...
`ifndef WHB
HB_184: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_184: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_184: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_184: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
