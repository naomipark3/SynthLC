...
`ifndef WHB
HB_186: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_186: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_186: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_186: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
