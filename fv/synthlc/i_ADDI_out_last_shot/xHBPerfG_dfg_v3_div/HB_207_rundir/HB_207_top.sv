...
`ifndef WHB
HB_207: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_207: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_207: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_207: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
