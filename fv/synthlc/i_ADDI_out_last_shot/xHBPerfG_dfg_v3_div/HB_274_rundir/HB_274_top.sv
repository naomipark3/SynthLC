...
`ifndef WHB
HB_274: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_274: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_274: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_274: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
