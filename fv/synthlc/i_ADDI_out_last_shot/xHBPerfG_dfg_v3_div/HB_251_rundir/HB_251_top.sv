...
`ifndef WHB
HB_251: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_251: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_251: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_251: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
