...
`ifndef WHB
HB_159: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_159: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_159: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_159: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
