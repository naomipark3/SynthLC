...
`ifndef WHB
HB_160: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_160: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_160: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_160: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
