...
`ifndef WHB
HB_356: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_356: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_356: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_356: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
