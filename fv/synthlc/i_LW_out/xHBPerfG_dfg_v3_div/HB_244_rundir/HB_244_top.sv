...
`ifndef WHB
HB_244: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_244: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_244: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_244: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
