...
`ifndef WHB
HB_149: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_149: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_149: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_149: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
