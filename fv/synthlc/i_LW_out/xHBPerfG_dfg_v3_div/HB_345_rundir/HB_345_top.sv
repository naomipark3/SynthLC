...
`ifndef WHB
HB_345: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_345: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_345: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_345: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
