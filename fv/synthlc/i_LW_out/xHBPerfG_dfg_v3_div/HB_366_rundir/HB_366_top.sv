...
`ifndef WHB
HB_366: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_366: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_366: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_366: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
