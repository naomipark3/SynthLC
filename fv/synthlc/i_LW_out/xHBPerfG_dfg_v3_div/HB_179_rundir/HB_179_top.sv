...
`ifndef WHB
HB_179: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_179: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_179: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_179: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
