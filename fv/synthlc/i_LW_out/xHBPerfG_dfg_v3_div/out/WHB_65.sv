...
`ifndef WHB
HB_65: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_65: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_65: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_65: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
