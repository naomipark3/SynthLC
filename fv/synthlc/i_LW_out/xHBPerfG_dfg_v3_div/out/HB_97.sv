...
`ifndef WHB
HB_97: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_97: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_97: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_97: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
