...
`ifndef WHB
HB_108: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_108: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_108: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_108: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
