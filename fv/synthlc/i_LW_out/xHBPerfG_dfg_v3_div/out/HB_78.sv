...
`ifndef WHB
HB_78: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_78: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_78: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_78: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
