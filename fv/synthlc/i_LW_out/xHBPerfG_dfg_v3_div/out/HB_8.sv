...
`ifndef WHB
HB_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_8: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_8: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
