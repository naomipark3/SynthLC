...
`ifndef WHB
HB_64: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_64: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_64: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_64: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
