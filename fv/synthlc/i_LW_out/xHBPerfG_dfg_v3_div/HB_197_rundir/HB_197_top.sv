...
`ifndef WHB
HB_197: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_197: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_197: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_197: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
