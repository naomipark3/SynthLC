...
`ifndef WHB
HB_225: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_225: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_225: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_225: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
