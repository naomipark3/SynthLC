...
`ifndef WHB
HB_370: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_370: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_370: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_370: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
