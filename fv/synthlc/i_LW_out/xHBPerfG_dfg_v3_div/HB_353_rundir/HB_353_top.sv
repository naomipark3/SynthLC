...
`ifndef WHB
HB_353: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_353: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_353: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_353: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
