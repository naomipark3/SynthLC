...
`ifndef WHB
HB_314: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_314: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_314: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_314: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
