...
`ifndef WHB
HB_283: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_283: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_283: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_283: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
