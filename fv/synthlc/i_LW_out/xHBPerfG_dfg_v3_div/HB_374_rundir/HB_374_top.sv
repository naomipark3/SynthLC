...
`ifndef WHB
HB_374: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_374: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_374: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_374: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
