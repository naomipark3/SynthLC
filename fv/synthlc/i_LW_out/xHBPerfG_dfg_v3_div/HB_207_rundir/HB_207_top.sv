...
`ifndef WHB
HB_207: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_207: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_207: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_207: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
