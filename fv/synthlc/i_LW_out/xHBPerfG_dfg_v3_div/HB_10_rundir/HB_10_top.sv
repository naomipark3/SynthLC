...
`ifndef WHB
HB_10: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_10: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_10: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_10: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
