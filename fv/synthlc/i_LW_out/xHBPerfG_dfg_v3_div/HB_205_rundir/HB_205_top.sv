...
`ifndef WHB
HB_205: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_205: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_205: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_205: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
