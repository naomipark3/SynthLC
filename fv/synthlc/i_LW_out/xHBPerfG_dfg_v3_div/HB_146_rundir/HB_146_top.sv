...
`ifndef WHB
HB_146: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_146: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_146: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_146: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
