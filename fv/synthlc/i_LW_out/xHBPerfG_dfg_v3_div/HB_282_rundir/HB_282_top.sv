...
`ifndef WHB
HB_282: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_282: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_282: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_282: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
