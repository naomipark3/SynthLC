...
`ifndef WHB
HB_262: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_262: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_262: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_262: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
