...
`ifndef WHB
HB_354: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_354: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_354: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_354: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
