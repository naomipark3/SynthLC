...
`ifndef WHB
HB_74: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_74: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_74: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_74: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
