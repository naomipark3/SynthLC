...
`ifndef WHB
HB_188: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_188: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_188: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_188: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
