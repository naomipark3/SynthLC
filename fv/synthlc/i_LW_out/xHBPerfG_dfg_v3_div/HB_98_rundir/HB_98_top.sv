...
`ifndef WHB
HB_98: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_98: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_98: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_98: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
