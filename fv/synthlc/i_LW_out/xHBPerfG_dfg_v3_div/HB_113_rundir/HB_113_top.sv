...
`ifndef WHB
HB_113: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_113: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_113: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_113: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
