...
`ifndef WHB
HB_245: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_245: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_245: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_245: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
