...
`ifndef WHB
HB_168: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_168: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_168: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_168: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
