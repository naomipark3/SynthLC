...
`ifndef WHB
HB_55: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_55: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_55: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_55: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
