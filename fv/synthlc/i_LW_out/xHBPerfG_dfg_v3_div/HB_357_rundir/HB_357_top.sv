...
`ifndef WHB
HB_357: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_357: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_357: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_357: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
