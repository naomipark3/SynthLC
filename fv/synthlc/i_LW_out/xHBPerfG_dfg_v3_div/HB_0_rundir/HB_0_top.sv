...
`ifndef WHB
HB_0: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_0: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_0: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_0: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
