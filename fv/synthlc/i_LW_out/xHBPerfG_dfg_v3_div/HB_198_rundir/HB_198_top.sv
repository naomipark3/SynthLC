...
`ifndef WHB
HB_198: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_198: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_198: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_198: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
