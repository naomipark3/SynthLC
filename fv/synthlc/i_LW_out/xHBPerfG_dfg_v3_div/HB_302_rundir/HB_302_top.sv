...
`ifndef WHB
HB_302: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_302: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_302: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_302: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
