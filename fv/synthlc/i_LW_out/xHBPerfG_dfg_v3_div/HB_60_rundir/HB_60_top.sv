...
`ifndef WHB
HB_60: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_60: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_60: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_60: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
