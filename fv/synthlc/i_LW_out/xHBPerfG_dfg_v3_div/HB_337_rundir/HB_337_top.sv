...
`ifndef WHB
HB_337: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_337: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_337: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_337: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
