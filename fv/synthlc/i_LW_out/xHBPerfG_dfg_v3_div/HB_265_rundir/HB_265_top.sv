...
`ifndef WHB
HB_265: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_265: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_265: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_265: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
