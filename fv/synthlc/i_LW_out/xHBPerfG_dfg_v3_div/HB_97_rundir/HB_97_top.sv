...
`ifndef WHB
HB_97: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_97: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_97: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_97: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
