...
`ifndef WHB
HB_295: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_295: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_295: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_295: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
