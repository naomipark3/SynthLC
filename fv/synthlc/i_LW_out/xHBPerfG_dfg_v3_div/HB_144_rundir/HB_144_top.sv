...
`ifndef WHB
HB_144: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_144: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_144: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_144: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
