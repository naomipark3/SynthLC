...
`ifndef WHB
HB_170: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_170: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_170: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_170: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
