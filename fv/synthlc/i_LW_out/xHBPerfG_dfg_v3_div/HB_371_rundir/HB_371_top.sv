...
`ifndef WHB
HB_371: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_371: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_371: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_371: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
