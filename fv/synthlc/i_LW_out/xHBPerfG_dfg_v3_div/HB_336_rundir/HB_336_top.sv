...
`ifndef WHB
HB_336: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_336: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_336: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_336: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
