...
`ifndef WHB
HB_190: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_190: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_190: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_190: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
