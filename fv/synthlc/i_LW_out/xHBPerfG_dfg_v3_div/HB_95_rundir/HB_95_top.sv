...
`ifndef WHB
HB_95: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_95: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_95: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_95: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
