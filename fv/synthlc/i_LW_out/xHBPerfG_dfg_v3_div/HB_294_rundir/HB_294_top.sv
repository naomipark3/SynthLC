...
`ifndef WHB
HB_294: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_294: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_294: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_294: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
