...
`ifndef WHB
HB_352: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_352: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_352: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_352: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
