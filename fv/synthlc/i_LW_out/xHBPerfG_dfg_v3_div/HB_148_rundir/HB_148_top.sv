...
`ifndef WHB
HB_148: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_148: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_148: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_148: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
