...
`ifndef WHB
HB_363: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_363: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_363: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_363: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
