...
`ifndef WHB
HB_359: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_359: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_359: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_359: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
