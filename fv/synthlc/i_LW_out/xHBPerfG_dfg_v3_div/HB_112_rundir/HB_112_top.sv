...
`ifndef WHB
HB_112: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_112: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_112: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_112: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
