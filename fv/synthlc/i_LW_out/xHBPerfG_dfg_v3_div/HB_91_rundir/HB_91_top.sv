...
`ifndef WHB
HB_91: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_91: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_91: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_91: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
