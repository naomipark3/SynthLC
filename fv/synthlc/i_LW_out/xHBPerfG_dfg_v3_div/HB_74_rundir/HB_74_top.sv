...
`ifndef WHB
HB_74: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_74: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_74: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_74: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
