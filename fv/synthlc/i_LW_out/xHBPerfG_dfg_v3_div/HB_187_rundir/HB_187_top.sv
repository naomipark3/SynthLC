...
`ifndef WHB
HB_187: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_187: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_187: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_187: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
