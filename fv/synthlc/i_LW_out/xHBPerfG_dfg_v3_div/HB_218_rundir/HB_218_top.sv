...
`ifndef WHB
HB_218: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_218: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_218: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_218: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
