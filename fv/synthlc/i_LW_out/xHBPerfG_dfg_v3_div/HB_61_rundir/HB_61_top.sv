...
`ifndef WHB
HB_61: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_61: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_61: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_61: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
