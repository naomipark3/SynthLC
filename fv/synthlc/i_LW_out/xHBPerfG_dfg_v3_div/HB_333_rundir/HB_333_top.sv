...
`ifndef WHB
HB_333: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_333: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_333: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_333: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
