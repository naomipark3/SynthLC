...
`ifndef WHB
HB_347: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_347: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_347: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_347: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
