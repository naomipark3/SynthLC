...
`ifndef WHB
HB_165: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_165: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_165: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_165: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
