...
`ifndef WHB
HB_344: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_344: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_344: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_344: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
