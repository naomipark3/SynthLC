...
`ifndef WHB
HB_150: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_150: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_150: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_150: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
