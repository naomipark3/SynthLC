...
C_38_N: cover property (@(posedge clk_i) id_stage_s1_hpn & div_fsm_s2_hpn & div_fsm_s9_hpn & lsu_fsm_s8_hpn & wb_stage_s1_hpn & 1'b1 & !(id_stage_s1 | div_fsm_s2 | div_fsm_s9 | lsu_fsm_s8 | wb_stage_s1 | 1'b0));
endmodule
