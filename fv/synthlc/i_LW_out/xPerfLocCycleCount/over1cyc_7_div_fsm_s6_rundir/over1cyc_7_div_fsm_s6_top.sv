...
A_PATH: assume property (@(posedge clk_i) first |-> s_eventually (id_stage_s1_hpn && div_fsm_s14_hpn && div_fsm_s6_hpn && lsu_fsm_s8_hpn && wb_stage_s1_hpn && 1 ));

CS_gt_div_fsm_s6_2: cover property (@(posedge clk_i) 
    div_fsm_s6 [*2] ##1 !div_fsm_s6 ##[0:$] id_stage_s1_hpn && div_fsm_s14_hpn && div_fsm_s6_hpn && lsu_fsm_s8_hpn && wb_stage_s1_hpn && 1 );
