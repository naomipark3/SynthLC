...
`ifndef WHB
HB_LEAVING_mult_fsm_s5_lsu_fsm_s8: assert property (@(posedge clk_i) 
    ($past(mult_fsm_s5, 2) && 
        $past(mult_fsm_s5) && (!mult_fsm_s5)) |-> 
    $past(!(lsu_fsm_s8_hpn || lsu_fsm_s8)));
`else 
WHB_LEAVING_mult_fsm_s5_hb_lsu_fsm_s8: assert property (@(posedge clk_i) 
    ($past(mult_fsm_s5, 2) && 
        $past(mult_fsm_s5) && (!mult_fsm_s5)) |-> $past(!(lsu_fsm_s8_hpn)));
WHB_CONCUR_LEAVING_mult_fsm_s5_hb_lsu_fsm_s8: assert property (@(posedge clk_i) 
    ($past(mult_fsm_s5, 2) && 
        $past(mult_fsm_s5) && (!mult_fsm_s5)) |-> $past(!(lsu_fsm_s8_hpn) && lsu_fsm_s8));
`endif 
