...
`ifndef WHB
HB_lsu_fsm_s8_LEAVING_mult_fsm_s5: assert property (@(posedge clk_i) 
    ($past(!lsu_fsm_s8_hpn) && lsu_fsm_s8 && (mult_fsm_s5_hpn || mult_fsm_s5)) |=>
     mult_fsm_s5);
`else 
WHB_lsu_fsm_s8_LEAVING_mult_fsm_s5: assert property (@(posedge clk_i) 
    ($past(!lsu_fsm_s8_hpn) && lsu_fsm_s8 && mult_fsm_s5_hpn) |->
    mult_fsm_s5);
WHB_CONCUR_lsu_fsm_s8_LEAVING_mult_fsm_s5: assert property (@(posedge clk_i) 
    ($past(!lsu_fsm_s8_hpn) && lsu_fsm_s8 && mult_fsm_s5_hpn && mult_fsm_s5) |=>
    (!mult_fsm_s5));
`endif 
