...
`ifndef WHB
HB_LEAVING_mult_fsm_s5_wb_stage_s1: assert property (@(posedge clk_i) 
    ($past(mult_fsm_s5, 2) && 
        $past(mult_fsm_s5) && (!mult_fsm_s5)) |-> 
    $past(!(wb_stage_s1_hpn || wb_stage_s1)));
`else 
WHB_LEAVING_mult_fsm_s5_hb_wb_stage_s1: assert property (@(posedge clk_i) 
    ($past(mult_fsm_s5, 2) && 
        $past(mult_fsm_s5) && (!mult_fsm_s5)) |-> $past(!(wb_stage_s1_hpn)));
WHB_CONCUR_LEAVING_mult_fsm_s5_hb_wb_stage_s1: assert property (@(posedge clk_i) 
    ($past(mult_fsm_s5, 2) && 
        $past(mult_fsm_s5) && (!mult_fsm_s5)) |-> $past(!(wb_stage_s1_hpn) && wb_stage_s1));
`endif 
