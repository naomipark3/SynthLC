...
`ifndef WHB
HB_LEAVING_div_fsm_s9_lsu_fsm_s8: assert property (@(posedge clk_i) 
    ($past(div_fsm_s9, 2) && 
        $past(div_fsm_s9) && (!div_fsm_s9)) |-> 
    $past(!(lsu_fsm_s8_hpn || lsu_fsm_s8)));
`else 
WHB_LEAVING_div_fsm_s9_hb_lsu_fsm_s8: assert property (@(posedge clk_i) 
    ($past(div_fsm_s9, 2) && 
        $past(div_fsm_s9) && (!div_fsm_s9)) |-> $past(!(lsu_fsm_s8_hpn)));
WHB_CONCUR_LEAVING_div_fsm_s9_hb_lsu_fsm_s8: assert property (@(posedge clk_i) 
    ($past(div_fsm_s9, 2) && 
        $past(div_fsm_s9) && (!div_fsm_s9)) |-> $past(!(lsu_fsm_s8_hpn) && lsu_fsm_s8));
`endif 
