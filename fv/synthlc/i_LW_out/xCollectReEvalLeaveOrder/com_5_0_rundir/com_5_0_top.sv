...
N_div_fsm_s10: assume property (@(posedge clk_i) !div_fsm_s10);

N_div_fsm_s11: assume property (@(posedge clk_i) !div_fsm_s11);

N_div_fsm_s12: assume property (@(posedge clk_i) !div_fsm_s12);
...
N_div_fsm_s4: assume property (@(posedge clk_i) !div_fsm_s4);

N_div_fsm_s5: assume property (@(posedge clk_i) !div_fsm_s5);

N_div_fsm_s6: assume property (@(posedge clk_i) !div_fsm_s6);

N_div_fsm_s9: assume property (@(posedge clk_i) !div_fsm_s9);
...
wire set_r = id_stage_s1_hpn && div_fsm_s14_hpn && lsu_fsm_s8_hpn && wb_stage_s1_hpn && 1'b1 ;

A_div_fsm_s14_concur_lsu_fsm_s8: assume property (@(posedge clk_i) (div_fsm_s14 & !div_fsm_s14_hpn) |-> (lsu_fsm_s8 & !lsu_fsm_s8_hpn));
A_div_fsm_s14_concur_lsu_fsm_s8_2: assume property (@(posedge clk_i) (lsu_fsm_s8 & !lsu_fsm_s8_hpn) |-> (div_fsm_s14 & !div_fsm_s14_hpn));

A_div_fsm_s14_concur_wb_stage_s1: assume property (@(posedge clk_i) (div_fsm_s14 & !div_fsm_s14_hpn) |-> (wb_stage_s1 & !wb_stage_s1_hpn));
A_div_fsm_s14_concur_wb_stage_s1_2: assume property (@(posedge clk_i) (wb_stage_s1 & !wb_stage_s1_hpn) |-> (div_fsm_s14 & !div_fsm_s14_hpn));
C_SETR: cover property (@(posedge clk_i) set_r);
