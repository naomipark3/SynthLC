...
wire set_r = id_stage_s1_hpn && div_fsm_s1_hpn && div_fsm_s14_hpn && div_fsm_s2_hpn && div_fsm_s3_hpn && div_fsm_s4_hpn && div_fsm_s5_hpn && div_fsm_s6_hpn && wb_stage_s1_hpn && 1'b1 ;

CS_div_fsm_s2_hb_div_fsm_s14: cover property (@(posedge clk_i) (div_fsm_s2 & !div_fsm_s2_hpn & !(div_fsm_s14_hpn | div_fsm_s14)) ##[0:$] set_r);

CS_div_fsm_s2_concur_div_fsm_s14: cover property (@(posedge clk_i) (div_fsm_s2 & !div_fsm_s2_hpn & div_fsm_s14 & !div_fsm_s14_hpn) ##[0:$] set_r);
