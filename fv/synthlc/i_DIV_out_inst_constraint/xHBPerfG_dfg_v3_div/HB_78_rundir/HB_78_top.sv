...
`ifndef WHB
HB_78: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_78: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_78: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_78: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
