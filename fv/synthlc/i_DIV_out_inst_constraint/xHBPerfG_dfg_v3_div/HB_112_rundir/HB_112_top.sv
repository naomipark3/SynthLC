...
`ifndef WHB
HB_112: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_112: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_112: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_112: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
