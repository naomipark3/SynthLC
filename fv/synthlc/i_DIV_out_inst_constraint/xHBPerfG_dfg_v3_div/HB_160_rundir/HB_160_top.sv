...
`ifndef WHB
HB_160: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_160: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_160: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_160: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
