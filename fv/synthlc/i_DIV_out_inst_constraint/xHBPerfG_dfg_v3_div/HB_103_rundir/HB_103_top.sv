...
`ifndef WHB
HB_103: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_103: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_103: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_103: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
