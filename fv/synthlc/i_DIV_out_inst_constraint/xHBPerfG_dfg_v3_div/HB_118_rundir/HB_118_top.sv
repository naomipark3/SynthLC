...
`ifndef WHB
HB_118: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_118: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_118: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_118: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
