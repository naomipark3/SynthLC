...
`ifndef WHB
HB_122: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_122: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_122: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_122: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
