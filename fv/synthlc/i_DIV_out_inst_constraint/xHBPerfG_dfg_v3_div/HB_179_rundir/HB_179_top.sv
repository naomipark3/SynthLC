...
`ifndef WHB
HB_179: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_179: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_179: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_179: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
