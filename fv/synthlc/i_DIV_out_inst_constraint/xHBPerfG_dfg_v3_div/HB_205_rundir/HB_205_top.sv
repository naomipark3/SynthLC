...
`ifndef WHB
HB_205: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_205: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_205: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_205: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
