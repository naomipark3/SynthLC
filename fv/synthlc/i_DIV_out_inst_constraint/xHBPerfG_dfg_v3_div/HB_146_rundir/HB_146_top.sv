...
`ifndef WHB
HB_146: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_146: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_146: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_146: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
