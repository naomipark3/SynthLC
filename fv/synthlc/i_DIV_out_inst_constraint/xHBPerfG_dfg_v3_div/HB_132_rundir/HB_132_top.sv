...
`ifndef WHB
HB_132: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_132: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_132: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_132: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
