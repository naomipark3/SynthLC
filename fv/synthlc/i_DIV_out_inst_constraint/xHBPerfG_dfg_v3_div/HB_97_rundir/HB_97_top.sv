...
`ifndef WHB
HB_97: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_97: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_97: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_97: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
