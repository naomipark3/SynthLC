...
`ifndef WHB
HB_131: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_131: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_131: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_131: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
