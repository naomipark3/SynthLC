...
`ifndef WHB
HB_91: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_91: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_91: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_91: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
