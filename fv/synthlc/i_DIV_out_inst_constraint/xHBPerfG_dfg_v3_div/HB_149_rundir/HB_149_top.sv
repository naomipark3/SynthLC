...
`ifndef WHB
HB_149: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_149: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_149: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_149: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
