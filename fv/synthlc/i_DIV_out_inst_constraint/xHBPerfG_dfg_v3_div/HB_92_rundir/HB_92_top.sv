...
`ifndef WHB
HB_92: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_92: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_92: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_92: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
