...
`ifndef WHB
HB_107: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_107: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_107: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_107: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
