...
`ifndef WHB
HB_207: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_207: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_207: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_207: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
