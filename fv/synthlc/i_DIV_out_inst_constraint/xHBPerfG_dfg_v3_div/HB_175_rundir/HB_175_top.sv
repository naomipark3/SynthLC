...
`ifndef WHB
HB_175: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_175: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_175: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_175: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
