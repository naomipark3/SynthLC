...
`ifndef WHB
HB_81: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_81: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_81: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_81: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
