...
`ifndef WHB
HB_139: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_139: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_139: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_139: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
