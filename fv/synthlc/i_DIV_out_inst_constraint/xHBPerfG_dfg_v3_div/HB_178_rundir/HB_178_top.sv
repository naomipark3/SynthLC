...
`ifndef WHB
HB_178: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_178: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_178: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_178: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
