...
`ifndef WHB
HB_104: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_104: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_104: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_104: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
