...
`ifndef WHB
HB_148: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_148: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_148: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_148: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
