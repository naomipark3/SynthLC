...
`ifndef WHB
HB_77: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_77: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_77: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_77: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
