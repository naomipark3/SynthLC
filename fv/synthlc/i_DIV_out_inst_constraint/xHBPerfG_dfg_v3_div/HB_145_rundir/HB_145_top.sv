...
`ifndef WHB
HB_145: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_145: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_145: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_145: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
