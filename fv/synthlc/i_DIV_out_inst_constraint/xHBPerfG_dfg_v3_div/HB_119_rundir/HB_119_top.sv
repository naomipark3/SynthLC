...
`ifndef WHB
HB_119: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_119: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_119: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_119: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
