...
`ifndef WHB
HB_201: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_201: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_201: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_201: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
