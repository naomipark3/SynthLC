...
`ifndef WHB
HB_140: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_140: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_140: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_140: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
