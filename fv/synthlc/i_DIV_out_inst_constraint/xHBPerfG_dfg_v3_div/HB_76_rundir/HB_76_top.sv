...
`ifndef WHB
HB_76: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_76: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_76: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_76: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
