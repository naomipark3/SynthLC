...
`ifndef WHB
HB_206: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_206: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_206: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_206: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
