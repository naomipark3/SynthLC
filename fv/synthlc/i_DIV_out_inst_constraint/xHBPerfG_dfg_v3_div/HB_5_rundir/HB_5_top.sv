...
`ifndef WHB
HB_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_5: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_5: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
