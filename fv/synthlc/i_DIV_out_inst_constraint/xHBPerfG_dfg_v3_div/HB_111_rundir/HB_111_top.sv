...
`ifndef WHB
HB_111: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_111: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_111: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_111: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
