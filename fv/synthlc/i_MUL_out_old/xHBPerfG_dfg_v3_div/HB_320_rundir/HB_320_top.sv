...
`ifndef WHB
HB_320: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_320: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_320: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_320: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
