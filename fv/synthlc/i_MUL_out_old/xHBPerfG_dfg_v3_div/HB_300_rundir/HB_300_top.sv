...
`ifndef WHB
HB_300: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_300: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_300: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_300: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
