...
`ifndef WHB
HB_297: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_297: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_297: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_297: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
