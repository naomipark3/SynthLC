...
`ifndef WHB
HB_316: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_316: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_316: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_316: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
