...
`ifndef WHB
HB_281: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_281: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_281: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_281: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
