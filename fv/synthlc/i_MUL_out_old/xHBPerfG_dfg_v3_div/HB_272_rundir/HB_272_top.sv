...
`ifndef WHB
HB_272: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_272: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_272: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_272: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
