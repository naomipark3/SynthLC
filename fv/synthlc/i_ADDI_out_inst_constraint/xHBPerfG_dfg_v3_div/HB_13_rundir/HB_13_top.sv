...
`ifndef WHB
HB_13: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_13: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_13: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_13: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
