...
C_28_N: cover property (@(posedge clk_i) id_stage_s1_hpn & div_fsm_s3_hpn & div_fsm_s4_hpn & div_fsm_s9_hpn & 1'b1 & !(id_stage_s1 | div_fsm_s3 | div_fsm_s4 | div_fsm_s9 | 1'b0));