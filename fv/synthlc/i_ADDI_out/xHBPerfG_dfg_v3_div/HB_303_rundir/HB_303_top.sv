...
`ifndef WHB
HB_303: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_303: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_303: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_303: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
