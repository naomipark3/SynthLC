...
`ifndef WHB
HB_56: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_56: cover property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_56: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_56: assert property (@(posedge clk_i) (mult_fsm_s2 && !mult_fsm_s2_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
