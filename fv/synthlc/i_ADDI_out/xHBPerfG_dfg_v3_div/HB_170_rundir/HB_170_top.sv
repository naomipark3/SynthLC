...
`ifndef WHB
HB_170: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_170: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_170: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_170: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
