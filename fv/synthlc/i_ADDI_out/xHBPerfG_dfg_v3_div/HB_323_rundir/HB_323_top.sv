...
`ifndef WHB
HB_323: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_323: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_323: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_323: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
