...
`ifndef WHB
HB_35: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_35: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_35: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_35: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
