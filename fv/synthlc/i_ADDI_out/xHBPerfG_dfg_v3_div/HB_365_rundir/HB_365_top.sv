...
`ifndef WHB
HB_365: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_365: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_365: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_365: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
