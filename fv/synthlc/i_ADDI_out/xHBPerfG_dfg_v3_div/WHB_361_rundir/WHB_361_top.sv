...
`ifndef WHB
HB_361: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_361: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_361: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_361: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
