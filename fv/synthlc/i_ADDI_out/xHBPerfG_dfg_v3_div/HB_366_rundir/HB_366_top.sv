...
`ifndef WHB
HB_366: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_366: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_366: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_366: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
