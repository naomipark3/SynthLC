...
`ifndef WHB
HB_167: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_167: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_167: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_167: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
