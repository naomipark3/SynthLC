...
`ifndef WHB
HB_381: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_381: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_381: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_381: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
