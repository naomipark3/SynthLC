...
`ifndef WHB
HB_240: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_240: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_240: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_240: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
