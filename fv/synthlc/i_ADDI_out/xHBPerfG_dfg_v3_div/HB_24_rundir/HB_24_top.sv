...
`ifndef WHB
HB_24: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_24: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_24: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_24: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
