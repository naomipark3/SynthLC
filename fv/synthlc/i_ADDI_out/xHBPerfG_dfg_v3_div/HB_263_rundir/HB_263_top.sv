...
`ifndef WHB
HB_263: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_263: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_263: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_263: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
