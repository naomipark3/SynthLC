...
`ifndef WHB
HB_324: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_324: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_324: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_324: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
