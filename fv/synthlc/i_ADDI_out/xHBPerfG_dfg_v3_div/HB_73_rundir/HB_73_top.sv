...
`ifndef WHB
HB_73: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_73: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_73: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_73: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
