...
`ifndef WHB
HB_211: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_211: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_211: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_211: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
