...
`ifndef WHB
HB_330: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_330: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_330: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_330: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
