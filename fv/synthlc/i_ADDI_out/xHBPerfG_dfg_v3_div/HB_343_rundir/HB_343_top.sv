...
`ifndef WHB
HB_343: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_343: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_343: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_343: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
