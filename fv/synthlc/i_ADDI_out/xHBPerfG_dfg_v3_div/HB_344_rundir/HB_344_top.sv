...
`ifndef WHB
HB_344: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_344: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_344: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_344: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
