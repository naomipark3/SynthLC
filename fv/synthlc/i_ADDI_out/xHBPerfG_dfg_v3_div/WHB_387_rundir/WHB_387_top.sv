...
`ifndef WHB
HB_387: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_387: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_387: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_387: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
