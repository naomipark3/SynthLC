...
`ifndef WHB
HB_1: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_1: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_1: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_1: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
