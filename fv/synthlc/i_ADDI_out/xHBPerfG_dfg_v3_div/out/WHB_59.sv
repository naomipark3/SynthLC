...
`ifndef WHB
HB_59: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_59: cover property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_59: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_59: assert property (@(posedge clk_i) (div_fsm_s12 && !div_fsm_s12_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
