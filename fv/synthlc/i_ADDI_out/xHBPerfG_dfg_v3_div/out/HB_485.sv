...
`ifndef WHB
HB_485: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_485: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_485: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_485: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
