...
`ifndef WHB
HB_191: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_191: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_191: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_191: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
