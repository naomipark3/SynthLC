...
`ifndef WHB
HB_188: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !(div_fsm_s2_hpn || div_fsm_s2));
`else 
//C_188: cover property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) && (div_fsm_s2 && !div_fsm_s2_hpn));
WHB_188: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> !div_fsm_s2_hpn);
WHB_CONCUR_188: assert property (@(posedge clk_i) (div_fsm_s10 && !div_fsm_s10_hpn) |-> (div_fsm_s2 && !div_fsm_s2_hpn));
`endif 
