...
`ifndef WHB
HB_316: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_316: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_316: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_316: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
