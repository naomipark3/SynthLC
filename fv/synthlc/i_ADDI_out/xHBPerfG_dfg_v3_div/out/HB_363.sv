...
`ifndef WHB
HB_363: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_363: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_363: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_363: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
