...
`ifndef WHB
HB_135: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_135: cover property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_135: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_135: assert property (@(posedge clk_i) (mult_fsm_s7 && !mult_fsm_s7_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
