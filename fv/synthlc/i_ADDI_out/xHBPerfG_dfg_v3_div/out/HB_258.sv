...
`ifndef WHB
HB_258: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_258: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_258: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_258: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
