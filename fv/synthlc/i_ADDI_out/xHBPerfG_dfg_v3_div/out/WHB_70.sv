...
`ifndef WHB
HB_70: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_70: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_70: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_70: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
