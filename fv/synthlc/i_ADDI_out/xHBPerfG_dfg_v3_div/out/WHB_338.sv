...
`ifndef WHB
HB_338: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_338: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_338: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_338: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
