...
`ifndef WHB
HB_308: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_308: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_308: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_308: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
