...
`ifndef WHB
HB_382: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_382: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_382: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_382: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
