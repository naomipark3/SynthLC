...
`ifndef WHB
HB_90: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_90: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_90: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_90: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
