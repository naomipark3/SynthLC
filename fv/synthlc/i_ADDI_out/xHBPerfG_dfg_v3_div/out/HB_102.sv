...
`ifndef WHB
HB_102: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_102: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_102: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_102: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
