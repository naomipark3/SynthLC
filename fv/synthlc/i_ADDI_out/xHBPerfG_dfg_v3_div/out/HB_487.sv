...
`ifndef WHB
HB_487: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(mult_fsm_s3_hpn || mult_fsm_s3));
`else 
//C_487: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (mult_fsm_s3 && !mult_fsm_s3_hpn));
WHB_487: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !mult_fsm_s3_hpn);
WHB_CONCUR_487: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (mult_fsm_s3 && !mult_fsm_s3_hpn));
`endif 
