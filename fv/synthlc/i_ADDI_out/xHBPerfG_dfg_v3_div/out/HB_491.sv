...
`ifndef WHB
HB_491: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_491: cover property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_491: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_491: assert property (@(posedge clk_i) (wb_stage_s1 && !wb_stage_s1_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
