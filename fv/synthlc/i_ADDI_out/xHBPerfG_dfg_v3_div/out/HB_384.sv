...
`ifndef WHB
HB_384: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_384: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_384: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_384: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
