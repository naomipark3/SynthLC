...
`ifndef WHB
HB_362: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !(div_fsm_s12_hpn || div_fsm_s12));
`else 
//C_362: cover property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) && (div_fsm_s12 && !div_fsm_s12_hpn));
WHB_362: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> !div_fsm_s12_hpn);
WHB_CONCUR_362: assert property (@(posedge clk_i) (div_fsm_s5 && !div_fsm_s5_hpn) |-> (div_fsm_s12 && !div_fsm_s12_hpn));
`endif 
