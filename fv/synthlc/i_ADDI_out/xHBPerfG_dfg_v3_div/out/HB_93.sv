...
`ifndef WHB
HB_93: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(mult_fsm_s7_hpn || mult_fsm_s7));
`else 
//C_93: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (mult_fsm_s7 && !mult_fsm_s7_hpn));
WHB_93: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !mult_fsm_s7_hpn);
WHB_CONCUR_93: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (mult_fsm_s7 && !mult_fsm_s7_hpn));
`endif 
