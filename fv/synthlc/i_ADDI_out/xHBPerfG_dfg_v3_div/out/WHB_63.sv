...
`ifndef WHB
HB_63: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_63: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_63: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_63: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
