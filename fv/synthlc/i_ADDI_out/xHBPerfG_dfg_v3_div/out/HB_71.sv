...
`ifndef WHB
HB_71: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(mult_fsm_s7_hpn || mult_fsm_s7));
`else 
//C_71: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (mult_fsm_s7 && !mult_fsm_s7_hpn));
WHB_71: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !mult_fsm_s7_hpn);
WHB_CONCUR_71: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (mult_fsm_s7 && !mult_fsm_s7_hpn));
`endif 
