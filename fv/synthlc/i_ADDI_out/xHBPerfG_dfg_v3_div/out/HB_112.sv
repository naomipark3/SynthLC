...
`ifndef WHB
HB_112: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_112: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_112: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_112: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
