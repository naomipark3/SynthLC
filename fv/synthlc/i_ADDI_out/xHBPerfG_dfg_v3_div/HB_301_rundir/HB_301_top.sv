...
`ifndef WHB
HB_301: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_301: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_301: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_301: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
