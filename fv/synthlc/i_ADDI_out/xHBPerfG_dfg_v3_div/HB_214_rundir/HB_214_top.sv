...
`ifndef WHB
HB_214: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(div_fsm_s6_hpn || div_fsm_s6));
`else 
//C_214: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (div_fsm_s6 && !div_fsm_s6_hpn));
WHB_214: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !div_fsm_s6_hpn);
WHB_CONCUR_214: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (div_fsm_s6 && !div_fsm_s6_hpn));
`endif 
