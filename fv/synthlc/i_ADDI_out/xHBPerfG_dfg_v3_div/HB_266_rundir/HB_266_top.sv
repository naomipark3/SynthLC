...
`ifndef WHB
HB_266: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_266: cover property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_266: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_266: assert property (@(posedge clk_i) (div_fsm_s4 && !div_fsm_s4_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
