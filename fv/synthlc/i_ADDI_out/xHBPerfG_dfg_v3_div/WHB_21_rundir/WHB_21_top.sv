...
`ifndef WHB
HB_21: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !(mult_fsm_s5_hpn || mult_fsm_s5));
`else 
//C_21: cover property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) && (mult_fsm_s5 && !mult_fsm_s5_hpn));
WHB_21: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> !mult_fsm_s5_hpn);
WHB_CONCUR_21: assert property (@(posedge clk_i) (mult_fsm_s6 && !mult_fsm_s6_hpn) |-> (mult_fsm_s5 && !mult_fsm_s5_hpn));
`endif 
