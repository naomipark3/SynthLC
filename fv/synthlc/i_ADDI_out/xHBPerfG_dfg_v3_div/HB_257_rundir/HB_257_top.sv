...
`ifndef WHB
HB_257: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_257: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_257: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_257: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
