...
`ifndef WHB
HB_22: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_22: cover property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_22: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_22: assert property (@(posedge clk_i) (mult_fsm_s1 && !mult_fsm_s1_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
