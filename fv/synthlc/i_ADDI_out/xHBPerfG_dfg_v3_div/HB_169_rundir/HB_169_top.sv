...
`ifndef WHB
HB_169: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_169: cover property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_169: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_169: assert property (@(posedge clk_i) (div_fsm_s1 && !div_fsm_s1_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
