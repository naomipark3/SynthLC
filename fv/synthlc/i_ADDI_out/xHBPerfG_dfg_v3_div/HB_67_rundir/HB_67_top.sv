...
`ifndef WHB
HB_67: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_67: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_67: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_67: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
