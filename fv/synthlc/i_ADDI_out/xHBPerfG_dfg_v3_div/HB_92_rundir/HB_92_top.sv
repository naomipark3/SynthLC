...
`ifndef WHB
HB_92: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !(mult_fsm_s6_hpn || mult_fsm_s6));
`else 
//C_92: cover property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) && (mult_fsm_s6 && !mult_fsm_s6_hpn));
WHB_92: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> !mult_fsm_s6_hpn);
WHB_CONCUR_92: assert property (@(posedge clk_i) (mult_fsm_s5 && !mult_fsm_s5_hpn) |-> (mult_fsm_s6 && !mult_fsm_s6_hpn));
`endif 
