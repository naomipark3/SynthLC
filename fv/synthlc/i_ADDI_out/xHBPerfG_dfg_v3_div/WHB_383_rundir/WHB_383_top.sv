...
`ifndef WHB
HB_383: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_383: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_383: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_383: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
