...
CS_gt_div_fsm_s4_2: cover property (@(posedge clk_i) 
    div_fsm_s4 [*2] ##1 !div_fsm_s4 ##[0:$] id_stage_s1_hpn && div_fsm_s1_hpn && div_fsm_s2_hpn && div_fsm_s3_hpn && div_fsm_s4_hpn && div_fsm_s5_hpn && div_fsm_s6_hpn && div_fsm_s9_hpn && 1 );
