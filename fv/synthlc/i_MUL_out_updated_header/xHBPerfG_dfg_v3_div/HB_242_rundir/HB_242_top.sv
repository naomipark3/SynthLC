...
`ifndef WHB
HB_242: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !(div_fsm_s5_hpn || div_fsm_s5));
`else 
//C_242: cover property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) && (div_fsm_s5 && !div_fsm_s5_hpn));
WHB_242: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> !div_fsm_s5_hpn);
WHB_CONCUR_242: assert property (@(posedge clk_i) (div_fsm_s2 && !div_fsm_s2_hpn) |-> (div_fsm_s5 && !div_fsm_s5_hpn));
`endif 
