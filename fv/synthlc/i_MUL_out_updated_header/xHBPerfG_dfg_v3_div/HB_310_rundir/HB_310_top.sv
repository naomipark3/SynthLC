...
`ifndef WHB
HB_310: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_310: cover property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_310: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_310: assert property (@(posedge clk_i) (div_fsm_s6 && !div_fsm_s6_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
