...
`ifndef WHB
HB_12: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s3_hpn || div_fsm_s3));
`else 
//C_12: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s3 && !div_fsm_s3_hpn));
WHB_12: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s3_hpn);
WHB_CONCUR_12: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s3 && !div_fsm_s3_hpn));
`endif 
