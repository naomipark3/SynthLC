...
`ifndef WHB
HB_247: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_247: cover property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_247: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_247: assert property (@(posedge clk_i) (div_fsm_s3 && !div_fsm_s3_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
