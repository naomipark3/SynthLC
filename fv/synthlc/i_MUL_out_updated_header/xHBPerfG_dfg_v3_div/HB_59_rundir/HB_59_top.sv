...
`ifndef WHB
HB_59: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(mult_fsm_s2_hpn || mult_fsm_s2));
`else 
//C_59: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (mult_fsm_s2 && !mult_fsm_s2_hpn));
WHB_59: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !mult_fsm_s2_hpn);
WHB_CONCUR_59: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (mult_fsm_s2 && !mult_fsm_s2_hpn));
`endif 
