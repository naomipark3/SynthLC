...
`ifndef WHB
HB_58: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !(mult_fsm_s1_hpn || mult_fsm_s1));
`else 
//C_58: cover property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) && (mult_fsm_s1 && !mult_fsm_s1_hpn));
WHB_58: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> !mult_fsm_s1_hpn);
WHB_CONCUR_58: assert property (@(posedge clk_i) (mult_fsm_s3 && !mult_fsm_s3_hpn) |-> (mult_fsm_s1 && !mult_fsm_s1_hpn));
`endif 
