...
`ifndef WHB
HB_13: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s4_hpn || div_fsm_s4));
`else 
//C_13: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s4 && !div_fsm_s4_hpn));
WHB_13: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s4_hpn);
WHB_CONCUR_13: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s4 && !div_fsm_s4_hpn));
`endif 
