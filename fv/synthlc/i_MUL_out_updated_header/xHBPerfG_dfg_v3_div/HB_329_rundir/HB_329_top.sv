...
`ifndef WHB
HB_329: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s1_hpn || div_fsm_s1));
`else 
//C_329: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s1 && !div_fsm_s1_hpn));
WHB_329: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s1_hpn);
WHB_CONCUR_329: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s1 && !div_fsm_s1_hpn));
`endif 
