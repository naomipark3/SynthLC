...
`ifndef WHB
HB_12: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_12: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_12: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_12: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
