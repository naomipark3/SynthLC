...
`ifndef WHB
HB_195: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_195: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_195: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_195: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
