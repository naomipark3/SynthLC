...
`ifndef WHB
HB_182: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_182: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_182: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_182: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
