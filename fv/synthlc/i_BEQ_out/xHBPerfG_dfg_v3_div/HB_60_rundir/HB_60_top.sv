...
`ifndef WHB
HB_60: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_60: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_60: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_60: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
