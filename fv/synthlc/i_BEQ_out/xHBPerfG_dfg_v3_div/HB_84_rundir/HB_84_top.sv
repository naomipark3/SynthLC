...
`ifndef WHB
HB_84: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s11_hpn || div_fsm_s11));
`else 
//C_84: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s11 && !div_fsm_s11_hpn));
WHB_84: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s11_hpn);
WHB_CONCUR_84: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s11 && !div_fsm_s11_hpn));
`endif 
