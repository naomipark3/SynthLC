...
`ifndef WHB
HB_87: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !(div_fsm_s14_hpn || div_fsm_s14));
`else 
//C_87: cover property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) && (div_fsm_s14 && !div_fsm_s14_hpn));
WHB_87: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> !div_fsm_s14_hpn);
WHB_CONCUR_87: assert property (@(posedge clk_i) (div_fsm_s9 && !div_fsm_s9_hpn) |-> (div_fsm_s14 && !div_fsm_s14_hpn));
`endif 
