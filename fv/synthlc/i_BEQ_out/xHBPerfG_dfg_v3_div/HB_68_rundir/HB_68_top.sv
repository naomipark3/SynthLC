...
`ifndef WHB
HB_68: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !(lsu_fsm_s8_hpn || lsu_fsm_s8));
`else 
//C_68: cover property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) && (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
WHB_68: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> !lsu_fsm_s8_hpn);
WHB_CONCUR_68: assert property (@(posedge clk_i) (div_fsm_s13 && !div_fsm_s13_hpn) |-> (lsu_fsm_s8 && !lsu_fsm_s8_hpn));
`endif 
