...
`ifndef WHB
HB_16: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(div_fsm_s9_hpn || div_fsm_s9));
`else 
//C_16: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (div_fsm_s9 && !div_fsm_s9_hpn));
WHB_16: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !div_fsm_s9_hpn);
WHB_CONCUR_16: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (div_fsm_s9 && !div_fsm_s9_hpn));
`endif 
