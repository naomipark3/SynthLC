...
`ifndef WHB
HB_49: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !(wb_stage_s1_hpn || wb_stage_s1));
`else 
//C_49: cover property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) && (wb_stage_s1 && !wb_stage_s1_hpn));
WHB_49: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> !wb_stage_s1_hpn);
WHB_CONCUR_49: assert property (@(posedge clk_i) (div_fsm_s11 && !div_fsm_s11_hpn) |-> (wb_stage_s1 && !wb_stage_s1_hpn));
`endif 
