...
`ifndef WHB
HB_93: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !(div_fsm_s10_hpn || div_fsm_s10));
`else 
//C_93: cover property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) && (div_fsm_s10 && !div_fsm_s10_hpn));
WHB_93: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> !div_fsm_s10_hpn);
WHB_CONCUR_93: assert property (@(posedge clk_i) (lsu_fsm_s8 && !lsu_fsm_s8_hpn) |-> (div_fsm_s10 && !div_fsm_s10_hpn));
`endif 
