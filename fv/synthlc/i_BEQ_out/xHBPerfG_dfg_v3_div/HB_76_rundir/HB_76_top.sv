...
`ifndef WHB
HB_76: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !(div_fsm_s13_hpn || div_fsm_s13));
`else 
//C_76: cover property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) && (div_fsm_s13 && !div_fsm_s13_hpn));
WHB_76: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> !div_fsm_s13_hpn);
WHB_CONCUR_76: assert property (@(posedge clk_i) (div_fsm_s14 && !div_fsm_s14_hpn) |-> (div_fsm_s13 && !div_fsm_s13_hpn));
`endif 
